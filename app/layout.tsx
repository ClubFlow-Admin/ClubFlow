        ...
        <header className="border-b bg-white">
          <div className="container-shell flex min-h-16 items-center justify-between gap-4">
            <Link href="/" className="flex items-center gap-3 no-underline">
              ...
              <div>
                <div className="text-lg font-black">ClubFlow</div>
                <div className="text-xs font-medium text-muted-foreground">Private club intelligence</div>
              </div>
            </Link>
            <nav className="hidden items-center gap-1 xl:flex">
              {categoryNav.slice(1).map((item) => (
                <Link
                  key={item.href + item.label}
                  href={item.href}
                  className="rounded-md px-3 py-2 text-sm font-semibold text-muted-foreground no-underline hover:bg-muted hover:text-foreground"
                >
                  {item.label}
                </Link>
              ))}
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/jobs"
                className="hidden rounded-md border px-3 py-2 text-sm font-semibold no-underline hover:bg-muted sm:inline-flex"
              >
